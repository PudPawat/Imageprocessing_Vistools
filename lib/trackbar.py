...
class TrackBar(object):
    ...
    class Contour_area(object):
        def __init__(self, preset = None):
            ...
            if preset is not None:
                self.area_min, self.area_max, self.n, self.b2s, self.factor_min, self.factor_max = preset
            else:
                self.area_min = 1
                self.area_max = 200
                self.n = 5
                self.b2s = 0
                self.factor_min = 1000
            ...
            self.factor_min_name = "factor_min"
            self.factor_max_name = "factor_max"
            ...
            cv.createTrackbar(self.area_min_name, self.window_contour_area_det_name, self.area_min, 3000,
                              self.on_min_name_size)

            cv.createTrackbar(self.area_max_name, self.window_contour_area_det_name, self.area_max, 3000,
            ...
            cv.createTrackbar(self.n_name, self.window_contour_area_det_name, self.n, 100,
                              self.on_n_name_size)
            cv.createTrackbar(self.factor_min_name, self.window_contour_area_det_name, self.factor_min, 1000,
                              self.on_factor_min)
            cv.createTrackbar(self.factor_max_name, self.window_contour_area_det_name, self.factor_max, 1000,
                              self.on_factor_max)
        ...
        def on_factor_min(self, val):
            self.factor_min = val
            cv.setTrackbarPos(self.factor_min_name, self.window_contour_area_det_name, self.factor_min)

        def on_factor_max(self, val):
            self.factor_max = val
            cv.setTrackbarPos(self.factor_max_name, self.window_contour_area_det_name, self.factor_max)

        def return_var(self):
            return (self.area_min, self.area_max, self.n, self.b2s, self.factor_min, self.factor_max)
